...
edge_dist_45_plot = ggplot(data.frame(x = edge_dist_45), aes(x)) + stat_ecdf() + 
	geom_segment(aes(x = 0.25, y = 0, xend = 1, yend = 1), color = 'red') +
	labs(x = '45-area distance', y = 'cumulative frequency')
	
edge_dist_15_plot = ggplot(data.frame(x = edge_dist_15), aes(x)) + stat_ecdf() + 
	geom_segment(aes(x = 0, y = 0, xend = 1, yend = 1), color = 'red') +
	labs(x = '15-area distance', y = 'cumulative frequency')
