...
Finally, we can calculate a "score" for each country, based on the number of the top 45 areas in which it has at least one researcher.  Unsurprisingly, this variable is strongly associated with the number of authors; but it does not appear to have any associations with any other variables.  
